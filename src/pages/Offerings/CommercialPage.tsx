...
const { commercial } = offeringContent;

function CommercialPage() {
  return (
    <>
      <MetaTags
        title="Commercial & Industrial Solar Solutions - C&I Rooftop Solar"
        description="Turn your commercial/industrial roof into a powerhouse with efficient C&I solar solutions. Reduce operating costs and achieve energy independence."
        canonical={`${SITE_URL}/offering/commercial`}
      />

      <PageHeader
        title={commercial.title}
        subtitle={commercial.subtitle}
        backgroundClass={commercial.backgroundClass}
      />
            ...
            <div className="col-lg-6 pe-lg-0" style={{ minHeight: '400px' }}>
              <div className="position-relative w-100 h-100">
                <img
                  ...
                  src={commercial.sections[0].image}
                ...
                <ScrollAnimation animation="fade-slide-up">
                  <div className="row g-4">
                    <ul className="advantages-list">
                      {commercial.sections[0].content.map((text, index) => (
                        <p key={index}>{text}</p>
                      ))}
                    </ul>
