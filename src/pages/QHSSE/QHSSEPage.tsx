    ...
    <>
      ...
      >
        ...
        <ScrollAnimation animation="fade-slide-up" delay={1}>
          <p>
            Wattglow Power values incorporating Health, Safety, Security, and Environmental
            standards into our business practices. It is committed to meeting the highest standards
            of health and safety for its people, including employees, contractors, visitors, and
            vendors while providing safe products and services to our customers.
          </p>
          <p>
            This commitment is at the forefront of our management system, and we shall tenaciously
            pursue our objective to continually improve all our processes and systems, thereby
            attaining a healthy and safe business performance.
          </p>
        </ScrollAnimation>
        <br />
      ...
      >
        ...
        <ScrollAnimation animation="fade-slide-up" delay={1}>
          <p>
            Wattglow Power is committed to understanding and exceeding our customers' expectations.
            The quality and integrity of our products and services are central to achieving customer
            satisfaction and propelling organizational growth. Every person owns the responsibility
